...
public class oAuthSina : oAuthBase
{
    ...
    public string appSecret
    {
        get
        {
            ...
            {
                _appSecret = "f075616f65ea34d0d4bbff0960ae39e6";
            }
            return _appSecret;
        }
        set { _appSecret = value; }
    }
    public string token { get { return _token; } set { _token = "5a0c5720357c27a94d25f0f1f43bfb40"; } }
    public string tokenSecret { get { return _tokenSecret ; } set { _tokenSecret = "c07f2af76f734568c213b7b7e81fbbb4"; } }
    #endregion
    private string _WebRequest(Method method, string url, string postData)
    {
        ...
        if (method == Method.POST)
        {
            ...
            {
                MessageBox.Show("新浪服务器错误，错误信息：" + e.Message);
            }
            finally
            {
                requestWriter.Close();
